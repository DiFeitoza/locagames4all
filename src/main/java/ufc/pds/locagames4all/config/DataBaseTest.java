...
public class DataBaseTest implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        Locacao l2 = new Locacao(c1, j2, LocalDate.parse("2022-06-01"), LocalDate.parse("2021-06-12"), LocalDate.parse("2021-06-06"));
        Locacao l3 = new Locacao(c2, j3, LocalDate.parse("2022-07-01"), LocalDate.parse("2021-07-20"), null);
